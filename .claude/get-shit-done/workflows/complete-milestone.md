...
```bash
node "/home/pigotz/Projects/drum-theory/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/home/pigotz/Projects/drum-theory/.claude/get-shit-done/templates/retrospective.md`.
