...
```
Task(
  prompt="Read /home/pigotz/Projects/drum-theory/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/pigotz/Projects/drum-theory/.claude/get-shit-done/templates/SECURITY.md`
