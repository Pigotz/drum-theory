...
- **Global scope**: `/home/pigotz/Projects/drum-theory/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/pigotz/Projects/drum-theory/.claude/notes/`)
...
2. Glob `/home/pigotz/Projects/drum-theory/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/pigotz/Projects/drum-theory/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/pigotz/Projects/drum-theory/.claude/notes/` — works in any directory
