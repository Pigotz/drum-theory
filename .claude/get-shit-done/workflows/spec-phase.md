...
```bash
INIT=$(node "/home/pigotz/Projects/drum-theory/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/pigotz/Projects/drum-theory/.claude/get-shit-done/templates/spec.md.
